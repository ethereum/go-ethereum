...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db brndb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db brndb.Database) error {
