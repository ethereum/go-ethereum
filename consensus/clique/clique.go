...
// ecrecover extracts the Burnout account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Burnout address
...
// Burnout testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     brndb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Burnout address of the signing key
...
func New(config *params.CliqueConfig, db brndb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Burnout address recovered
