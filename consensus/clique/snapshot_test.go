...
// mapped from textual names used in the tests below to actual AkoinCash private
...
// address retrieves the AkoinCash address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the AkoinCash address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/dezzyboy/go-ethereum/issues/17593). Whilst this
