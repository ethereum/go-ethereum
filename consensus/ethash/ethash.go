...
// all blocks' seal as valid, though they still have to conform to the Burnout
// consensus rules.
...
// still have to conform to the Burnout consensus rules.
...
// they still have to conform to the Burnout consensus rules.
