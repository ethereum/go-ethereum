...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*gapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx gapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*gapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := gapi.SignTransactionResult{Raw: data, Tx: signedTx}
