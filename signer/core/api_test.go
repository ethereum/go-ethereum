...
func signTextValidator(t *testing.T) {
	// TODO
}
...
func signTextPlain(t *testing.T) {
	api, control := setup(t)
	//Create two accounts
	createAccount(control, api, t)
	createAccount(control, api, t)
	...
	h, err := api.SignData(context.Background(), TextPlain.Mime, a, []byte("EHLO world"))
	if h != nil {
...
func signTypedData(t *testing.T) {
	// TODO
}
