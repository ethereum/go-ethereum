...
func (s *UIServerAPI) Import(_ context.Context, keyJSON json.RawMessage, oldPassphrase, newPassphrase string) (accounts.Account, error) {
...
// the user
func (s *UIServerAPI) New(_ context.Context) (common.Address, error) {
