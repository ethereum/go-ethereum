...
func ExampleMetrics() metrics.Registry {
	...
	metrics.NewRegisteredResettingGauge("test/empty_resetting_gauge", registry)
	{
		gauge := metrics.NewRegisteredResettingGauge("test/resetting_gauge", registry)
		gauge.Update(23456)
	}
	{
		gauge := metrics.NewRegisteredResettingGauge("test/resetting_gauge_reset", registry)
		gauge.Update(23456)
		gauge.Snapshot()
	}
	...
	metrics.NewRegisteredResettingTimer("test/empty_resetting_timer", registry).Snapshot()
