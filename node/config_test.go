...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "aiigo.ipc", false, filepath.Join(os.TempDir(), "aiigo.ipc")},
		{"data", "aiigo.ipc", false, "data/aiigo.ipc"},
		{"data", "./aiigo.ipc", false, "./aiigo.ipc"},
		{"data", "/aiigo.ipc", false, "/aiigo.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "aiigo.ipc", true, `\\.\pipe\aiigo.ipc`},
		{"data", "aiigo.ipc", true, `\\.\pipe\aiigo.ipc`},
		{"data", `\\.\pipe\aiigo.ipc`, true, `\\.\pipe\aiigo.ipc`},
	}
