...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the Essentia protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the Essentia protocol to
...
// Node represents a Geth Essentia node instance.
type Node struct {
	node *node.Node
}
...
// GetEthereumClient retrieves a client to access the Essentia subsystem.
