...
// Contains a wrapper for the AkoinCash client.
...
// AkoinCashClient provides access to the AkoinCash APIs.
type AkoinCashClient struct {
	client *ethclient.Client
}

// NewAkoinCashClient connects a client to the given URL.
func NewAkoinCashClient(rawurl string) (client *AkoinCashClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &AkoinCashClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *AkoinCashClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *AkoinCashClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *AkoinCashClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *AkoinCashClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *AkoinCashClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *AkoinCashClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *AkoinCashClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *AkoinCashClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *AkoinCashClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *AkoinCashClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *AkoinCashClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *AkoinCashClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *AkoinCashClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *AkoinCashClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *AkoinCashClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *AkoinCashClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *AkoinCashClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *AkoinCashClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *AkoinCashClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *AkoinCashClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *AkoinCashClient) SendTransaction(ctx *Context, tx *Transaction) error {
