 ...
 * @param {String} unit the unit to convert to, default chy
...
/**
 * Takes a number of chy and converts it to any other shift unit.
 *
 * Possible units are:
 *    'Chy',
 *    'Kchy',
 ...
 * @param {String} unit the unit to convert from, default Chy
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
