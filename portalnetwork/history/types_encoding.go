...
// Hash: e3ef9ad54d5a37e7d7a39c518f58dfad310dfc9218e4637043f4ea458dd89b91
// Version: 0.1.3
package history
...
func (b *BlockHeaderWithProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Proof'
	if size := len(b.Proof); size > 512 {
		err = ssz.ErrBytesLengthFn("BlockHeaderWithProof.Proof", size, 512)
		return
	}
