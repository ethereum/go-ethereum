...
// Package ethereum defines interfaces for interacting with AkoinCash.
package ethereum
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by acash_getLogs, return logs only from block with this hash
