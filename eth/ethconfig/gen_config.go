...
func (c Config) MarshalTOML() (interface{}, error) {
	type Config struct {
		...
		RPCGlobalEvmEstimateGasTimeoutFactor uint64
		RPCTxFeeCap                          float64
	...
	enc.RPCGlobalEvmEstimateGasTimeoutFactor = c.RPCGlobalEvmEstimateGasTimeoutFactor
...
func (c *Config) UnmarshalTOML(unmarshal func(interface{}) error) error {
	...
	if dec.RPCGlobalEvmEstimateGasTimeoutFactor != nil {
		c.RPCGlobalEvmEstimateGasTimeoutFactor = *dec.RPCGlobalEvmEstimateGasTimeoutFactor
	}
