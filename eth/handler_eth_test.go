...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, engine, core.SetChainConfig(configNoFork))
		chainProFork, _ = core.NewBlockChain(dbProFork, engine, core.SetChainConfig(configProFork))
