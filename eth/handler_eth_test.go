...
func testRecvTransactions(t *testing.T, protocol uint) {
	...
	tx := types.NewTransaction(0, common.Address{}, big.NewInt(0), 100000, big.NewInt(0), nil, "author")
...
func testSendTransactions(t *testing.T, protocol uint) {
	...
	for nonce := range insert {
		tx := types.NewTransaction(uint64(nonce), common.Address{}, big.NewInt(0), 100000, big.NewInt(0), make([]byte, 10240), "author")
		tx, _ = types.SignTx(tx, types.HomesteadSigner{}, testKey)
...
func testTransactionPropagation(t *testing.T, protocol uint) {
	...
	for nonce := range txs {
		tx := types.NewTransaction(uint64(nonce), common.Address{}, big.NewInt(0), 100000, big.NewInt(0), nil, "author")
		tx, _ = types.SignTx(tx, types.HomesteadSigner{}, testKey)
