...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		chainNoFork, _  = core.NewBlockChain(core.NewBlockChainConfig(dbNoFork, nil, configNoFork, engine, vm.Config{}, nil), nil)
		chainProFork, _ = core.NewBlockChain(core.NewBlockChainConfig(dbProFork, nil, configProFork, engine, vm.Config{}, nil), nil)
