...
func TestMultiSynchronisation65Light(t *testing.T) {
	testMultiSynchronisation(t, eth.ETH65, LightSync)
}
...
func TestMultiProtoSynchronisation65Light(t *testing.T) {
	testMultiProtoSync(t, eth.ETH65, LightSync)
}
...
func TestInvalidHeaderRollback65Fast(t *testing.T) {
	testInvalidHeaderRollback(t, eth.ETH65, FastSync)
}
func TestInvalidHeaderRollback66Fast(t *testing.T) {
	testInvalidHeaderRollback(t, eth.ETH66, FastSync)
}
...
func TestCheckpointEnforcement65Full(t *testing.T) {
	testCheckpointEnforcement(t, eth.ETH65, FullSync)
}
func TestCheckpointEnforcement65Fast(t *testing.T) {
	testCheckpointEnforcement(t, eth.ETH65, FastSync)
}
...
func TestCheckpointEnforcement66Fast(t *testing.T) {
	testCheckpointEnforcement(t, eth.ETH66, FastSync)
}
