...
import (
	...
	"github.com/chattynet/chatty/eth/fetcher"
...
func (pm *ProtocolManager) removePeer(id string) {
	...
	// Unregister the peer from the downloader and Chatty peer set
...
func (pm *ProtocolManager) Stop() {
	...
	glog.V(logger.Info).Infoln("Stopping Chatty protocol handler...")
	...
	glog.V(logger.Info).Infoln("Chatty protocol handler stopped")
}
