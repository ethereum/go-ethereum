...
func (l *JSONLogger) CaptureStart(to common.Address, gas uint64) {
}
...
func (l *JSONLogger) CaptureTxStart(env *vm.EVM, from common.Address, create bool, input []byte, gasLimit uint64, value *big.Int, rules params.Rules) {
	l.env = env
}
