...
func callframe_tracerJs() (*asset, error) {
	...
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xae, 0xac, 0xeb, 0x36, 0x91, 0xf2, 0x8b, 0x29, 0xaa, 0xa, 0x55, 0x2e, 0xc4, 0xd7, 0x3b, 0xab, 0x2f, 0xac, 0xf6, 0x18, 0xe0, 0x18, 0x64, 0x36, 0xc4, 0xdf, 0xd9, 0xdc, 0xe9, 0xb1, 0x94, 0x78}}
	return a, nil
}
