...
func TestForkIDSplit(t *testing.T) {
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, configNoFork, engine, new(vm.Config), nil, nil)
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, configProFork, engine, new(vm.Config), nil, nil)
