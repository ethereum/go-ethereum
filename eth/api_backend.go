...
func (b *EthAPIBackend) GetReceiptByLookupResult(tx *types.Transaction, blockHash common.Hash, blockNumber, blockIndex uint64) *types.Receipt {
	return b.eth.blockchain.GetReceiptByLookupResult(tx, blockHash, blockNumber, blockIndex)
}
