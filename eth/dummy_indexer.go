...
func (*dummyIndexer) SetHistoryCutoff(blockNumber uint64) {
	fmt.Println("*** SetHistoryCutoff", blockNumber)
}

func (*dummyIndexer) SetFinalized(blockNumber uint64) {
	fmt.Println("*** SetFinalized", blockNumber)
}

func (*dummyIndexer) Suspended() {
