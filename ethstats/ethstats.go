...
type Service struct {
	...
	les    *les.LightEthereum // Light Essentia service if monitoring a light node
...
func New(url string, ethServ *ess.Essentia, lesServ *les.LightEthereum) (*Service, error) {
