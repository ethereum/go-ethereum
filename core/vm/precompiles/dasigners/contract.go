...
// IDASignersParams is an auto generated low-level Go binding around an user-defined struct.
type IDASignersParams struct {
	TokensPerVote     *big.Int
	MaxVotesPerSigner *big.Int
	MaxQuorums        *big.Int
	EpochBlocks       *big.Int
	EncodedSlices     *big.Int
}
