...
// RegisterNextEpoch is a paid mutator transaction binding the contract method 0x0f62bda5.
//
// Solidity: function registerNextEpoch(address signer, (uint256,uint256) _signature, uint256 votes) returns()
func (_DASigners *DASignersTransactor) RegisterNextEpoch(opts *bind.TransactOpts, signer common.Address, _signature BN254G1Point, votes *big.Int) (*types.Transaction, error) {
	return _DASigners.contract.Transact(opts, "registerNextEpoch", signer, _signature, votes)
}

// RegisterNextEpoch is a paid mutator transaction binding the contract method 0x0f62bda5.
//
// Solidity: function registerNextEpoch(address signer, (uint256,uint256) _signature, uint256 votes) returns()
func (_DASigners *DASignersSession) RegisterNextEpoch(signer common.Address, _signature BN254G1Point, votes *big.Int) (*types.Transaction, error) {
	return _DASigners.Contract.RegisterNextEpoch(&_DASigners.TransactOpts, signer, _signature, votes)
}

// RegisterNextEpoch is a paid mutator transaction binding the contract method 0x0f62bda5.
//
// Solidity: function registerNextEpoch(address signer, (uint256,uint256) _signature, uint256 votes) returns()
func (_DASigners *DASignersTransactorSession) RegisterNextEpoch(signer common.Address, _signature BN254G1Point, votes *big.Int) (*types.Transaction, error) {
	return _DASigners.Contract.RegisterNextEpoch(&_DASigners.TransactOpts, signer, _signature, votes)
}
