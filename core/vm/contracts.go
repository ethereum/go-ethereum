...
// SYSCOIN RunPrecompiledContract runs and evaluates the output of a precompiled contract.
// It returns
// - the returned bytes,
// - the _remaining_ gas,
// - any error that occurred
func RunPrecompiledContract(p PrecompiledContract, input []byte, suppliedGas uint64, logger *tracing.Hooks, interpreter *EVMInterpreter) (ret []byte, remainingGas uint64, err error) {
...
// SYSCOIN
func (c *bls12381G1Mul) Run(input []byte, interpreter *EVMInterpreter) ([]byte, error) {
...
// SYSCOIN
func (c *bls12381G2Mul) Run(input []byte, interpreter *EVMInterpreter) ([]byte, error) {
