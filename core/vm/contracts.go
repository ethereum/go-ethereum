...
type DynamicGasPrecompiledContract interface {
	RunAndCalculateGas(evm *EVM, sender common.Address, callingContract common.Address, input []byte, suppliedGas uint64) (ret []byte, remainingGas uint64, err error) // Run runs the precompiled contract and calculate gas dynamically
}
...
func (c *Ecrecover) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
...
func (c *Sha256hash) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
...
func (c *Ripemd160hash) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
...
func (c *DataCopy) Run(_ *EVM, _ common.Address, in []byte) ([]byte, error) {
...
func (c *BigModExp) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
	var (
...
func (c *Bn256AddIstanbul) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
...
func (c *bn256AddByzantium) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
	return runBn256Add(input)
}
...
func (c *Bn256ScalarMulIstanbul) Run(_ *EVM, _ common.Address, input []byte) ([]byte, error) {
