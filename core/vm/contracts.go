...
// PrecompiledContractsHomestead contains the default set of pre-compiled Burnout
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Burnout
