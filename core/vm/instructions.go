...
func opExtCodeSize(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	if interpreter.evm.chainConfig.IsCancun(interpreter.evm.Context.BlockNumber.Uint64()) {
...
func opPush1(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	*pc += 1
	if *pc < codeLen {
		...
		if interpreter.evm.chainConfig.IsCancun(interpreter.evm.Context.BlockNumber.Uint64()) && *pc%31 == 0 {
