...
func opCreate(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	scope.Contract.UseGas(gas, interpreter.evm.tracer, tracing.GasChangeCallContractCreation)
	...
	scope.Contract.RefundGas(returnGas, interpreter.evm.tracer, tracing.GasChangeCallLeftOverRefunded)
...
func opCreate2(pc *uint64, interpreter *EVMInterpreter, scope *ScopeContext) ([]byte, error) {
	...
	// Apply EIP150
	gas -= gas / 64
	scope.Contract.UseGas(gas, interpreter.evm.tracer, tracing.GasChangeCallContractCreation2)
	// reuse size int for stackvalue
	stackvalue := size
