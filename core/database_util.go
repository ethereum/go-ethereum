...
func GetCanonicalHash(db ethdb.ReadWriter, number uint64) common.Hash {
...
func GetHeadHeaderHash(db ethdb.ReadWriter) common.Hash {
...
func GetHeadBlockHash(db ethdb.ReadWriter) common.Hash {
...
func GetHeadFastBlockHash(db ethdb.ReadWriter) common.Hash {
...
func GetHeaderRLP(db ethdb.ReadWriter, hash common.Hash) rlp.RawValue {
...
// found.
func GetHeader(db ethdb.ReadWriter, hash common.Hash) *types.Header {
...
func GetBodyRLP(db ethdb.ReadWriter, hash common.Hash) rlp.RawValue {
...
func GetBody(db ethdb.ReadWriter, hash common.Hash) *types.Body {
...
// none found.
func GetTd(db ethdb.ReadWriter, hash common.Hash) *big.Int {
...
func GetBlock(db ethdb.ReadWriter, hash common.Hash) *types.Block {
...
func GetBlockReceipts(db ethdb.ReadWriter, hash common.Hash) types.Receipts {
...
func GetTransaction(db ethdb.ReadWriter, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db ethdb.ReadWriter, txHash common.Hash) *types.Receipt {
...
func WriteHeadHeaderHash(db ethdb.ReadWriter, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db ethdb.ReadWriter, hash common.Hash) error {
...
func WriteHeader(db ethdb.ReadWriter, header *types.Header) error {
...
func WriteBody(db ethdb.ReadWriter, hash common.Hash, body *types.Body) error {
...
func WriteTd(db ethdb.ReadWriter, hash common.Hash, td *big.Int) error {
...
func WriteBlock(db ethdb.ReadWriter, block *types.Block) error {
...
func WriteBlockReceipts(db ethdb.ReadWriter, hash common.Hash, receipts types.Receipts) error {
...
func WriteReceipts(db ethdb.ReadWriter, receipts types.Receipts) error {
	// XXX Batch has been commented out because this is now used for transaction stuff as well
	...
	for _, receipt := range receipts {
		...
		if err := db.Put(append(receiptsPrefix, receipt.TxHash.Bytes()...), data); err != nil {
			return err
		}
	}
	/*
...
func DeleteBlockReceipts(db ethdb.ReadWriter, hash common.Hash) {
	db.Delete(append(blockReceiptsPrefix, hash.Bytes()...))
}

// DeleteTransaction removes all transaction data associated with a hash.
func DeleteTransaction(db ethdb.ReadWriter, hash common.Hash) {
...
func DeleteReceipt(db ethdb.ReadWriter, hash common.Hash) {
...
func GetBlockByHashOld(db ethdb.ReadWriter, hash common.Hash) *types.Block {
...
// MIP bloom bin.
func WriteMipmapBloom(db ethdb.ReadWriter, number uint64, receipts types.Receipts) error {
	// XXX Batch has been commented out because this is now used for transaction stuff as well
	// if you want to use batches perhaps you should pass a batch, rather than a database?
	//batch := db.NewBatch()
...
func GetMipmapBloom(db ethdb.ReadWriter, number, level uint64) types.Bloom {
	bloomDat, _ := db.Get(mipmapKey(number, level))
	return types.BytesToBloom(bloomDat)
}

// GetBlockChainVersion reads the version number from db.
func GetBlockChainVersion(db ethdb.ReadWriter) int {
	var vsn uint
...
func WriteBlockChainVersion(db ethdb.ReadWriter, vsn int) {
	enc, _ := rlp.EncodeToBytes(uint(vsn))
	db.Put([]byte("BlockchainVersion"), enc)
}

// WriteChainConfig writes the chain config settings to the database.
func WriteChainConfig(db ethdb.ReadWriter, hash common.Hash, cfg *ChainConfig) error {
...
func GetChainConfig(db ethdb.ReadWriter, hash common.Hash) (*ChainConfig, error) {
