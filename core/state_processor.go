...
func ProcessBeaconBlockRoot(beaconRoot common.Hash, evm *vm.EVM) {
	...
	_, _, _ = evm.Call(vm.AccountRef(msg.From), *msg.To, msg.Data, 36_000_000, common.U2560)
	evm.StateDB.Finalise(true)
}
...
func ProcessParentBlockHash(prevHash common.Hash, evm *vm.EVM) {
	...
	_, _, err := evm.Call(vm.AccountRef(msg.From), *msg.To, msg.Data, 36_000_000, common.U2560)
	if err != nil {
		panic(err)
	}
...
func processRequestsSystemCall(requests *[][]byte, evm *vm.EVM, requestType byte, addr common.Address) {
	...
	ret, _, _ := evm.Call(vm.AccountRef(msg.From), *msg.To, msg.Data, 36_000_000, common.U2560)
	evm.StateDB.Finalise(true)
	if len(ret) == 0 {
