...
// stateObject represents an Burnout account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of burnout address of the account
	data     Account
	db       *StateDB
...
// Account is the Burnout consensus representation of accounts.
