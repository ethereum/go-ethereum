...
func TestDump(t *testing.T) {
	...
	obj1.AddBalance(uint256.NewInt(22), live.BalanceChangeUnspecified)
	obj2 := s.state.getOrNewStateObject(common.BytesToAddress([]byte{0x01, 0x02}))
	obj2.SetCode(crypto.Keccak256Hash([]byte{3, 3, 3, 3, 3, 3, 3}), []byte{3, 3, 3, 3, 3, 3, 3})
	obj3 := s.state.getOrNewStateObject(common.BytesToAddress([]byte{0x02}))
	obj3.SetBalance(uint256.NewInt(44), live.BalanceChangeUnspecified)
...
func TestIterativeDump(t *testing.T) {
	...
	obj4.AddBalance(uint256.NewInt(1337), live.BalanceChangeUnspecified)
...
func TestSnapshot2(t *testing.T) {
	...
	so0.SetBalance(uint256.NewInt(42), live.BalanceChangeUnspecified)
	so0.SetNonce(43)
	...
	so1.SetBalance(uint256.NewInt(52), live.BalanceChangeUnspecified)
	so1.SetNonce(53)
