...
func TestUpdateLeaks(t *testing.T) {
	...
	for i := byte(0); i < 255; i++ {
		...
		state.AddBalance(addr, uint256.NewInt(uint64(11*i)), live.BalanceChangeUnspecified)
...
func TestIntermediateLeaks(t *testing.T) {
	...
	modify := func(state *StateDB, addr common.Address, i, tweak byte) {
		state.SetBalance(addr, uint256.NewInt(uint64(11*i)+uint64(tweak)), live.BalanceChangeUnspecified)
...
func TestCopy(t *testing.T) {
	...
	for i := byte(0); i < 255; i++ {
		...
		obj.AddBalance(uint256.NewInt(uint64(i)), live.BalanceChangeUnspecified)
	...
	for i := byte(0); i < 255; i++ {
		...
		origObj.AddBalance(uint256.NewInt(2*uint64(i)), live.BalanceChangeUnspecified)
		copyObj.AddBalance(uint256.NewInt(3*uint64(i)), live.BalanceChangeUnspecified)
		ccopyObj.AddBalance(uint256.NewInt(4*uint64(i)), live.BalanceChangeUnspecified)
...
func newTestAction(addr common.Address, r *rand.Rand) testAction {
	actions := []testAction{
		...
		},
		{
			name: "AddBalance",
			fn: func(a testAction, s *StateDB) {
				s.AddBalance(addr, uint256.NewInt(uint64(a.args[0])), live.BalanceChangeUnspecified)
			},
			args: make([]int64, 1),
		},
		{
...
func TestTouchDelete(t *testing.T) {
	...
	s.state.AddBalance(common.Address{}, new(uint256.Int), live.BalanceChangeUnspecified)
...
func TestCopyOfCopy(t *testing.T) {
	...
	state.SetBalance(addr, uint256.NewInt(42), live.BalanceChangeUnspecified)
...
func TestCopyCommitCopy(t *testing.T) {
	...
	state.SetBalance(addr, uint256.NewInt(42), live.BalanceChangeUnspecified) // Change the account trie
...
func TestDeleteCreateRevert(t *testing.T) {
	...
	state.SetBalance(addr, uint256.NewInt(1), live.BalanceChangeUnspecified)
	...
	id := state.Snapshot()
	state.SetBalance(addr, uint256.NewInt(2), live.BalanceChangeUnspecified)
...
func testMissingTrieNodes(t *testing.T, scheme string) {
	...
	addr := common.BytesToAddress([]byte("so"))
	{
		...
		state.SetBalance(a2, uint256.NewInt(100), live.BalanceChangeUnspecified)
