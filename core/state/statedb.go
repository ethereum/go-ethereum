...
func (s *StateDB) Commit(block uint64, deleteEmptyObjects bool, rawStorageKey bool) (common.Hash, error) {
	ret, err := s.commit(deleteEmptyObjects, rawStorageKey, block, false)
	if err != nil {
...
func (s *StateDB) CommitAndTrack(block uint64, deleteEmptyObjects bool, rawStorageKey bool, sizer *SizeTracker) (common.Hash, error) {
	ret, err := s.commit(deleteEmptyObjects, rawStorageKey, block, true)
	if err != nil {
		return common.Hash{}, err
	}
	sizer.Notify(ret)
