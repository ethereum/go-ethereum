...
func TestEIP2780Intrinsic(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			to:    nil,
			value: uint256.NewInt(1),
			// TxBaseCost + CreateAccess = 23,000 regular, identical to the
		...
		},
		{
			...
			want: params.TxBaseCost2780 + params.ColdAccountAccessAmsterdam + params.TxValueCost2780 + 3*params.RegularPerAuthBaseCost,
		},
	}
...
func TestEIP2780Gas(t *testing.T) {
	...
	cases := []struct {
		...
		// case 10: contract-creation transaction, value > 0; identical to the
		// value = 0 case, the recipient balance write is covered by CreateAccess.
...
func TestEIP2780RecipientOOG(t *testing.T) {
	...
	intrinsic := params.TxBaseCost2780 + params.ColdAccountAccessAmsterdam + params.TxValueCost2780 + params.RegularPerAuthBaseCost
