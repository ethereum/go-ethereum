...
// NewID calculates the AkoinCash fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the AkoinCash fork ID from an existing chain instance.
