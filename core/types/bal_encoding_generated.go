...
// Hash: 4c92003897c1e948ab34c65746774d783ecd567efe3cf3e82ac92dedd9b76e66
// Version: 0.1.3
package types
...
func (e *encodingAccountAccess) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	offset += len(e.BalanceChanges) * 24
...
func (e *encodingAccountAccess) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o3:o4]
		num, err := ssz.DivideInt2(len(buf), 24, 300000)
		if err != nil {
			return err
		}
		e.BalanceChanges = make([]encodingBalanceChange, num)
		for ii := 0; ii < num; ii++ {
			if err = e.BalanceChanges[ii].UnmarshalSSZ(buf[ii*24 : (ii+1)*24]); err != nil {
				return err
			}
		}
	}
