...
// Package types contains data types related to Burnout consensus.
package types
...
// Header represents a block header in the Burnout blockchain.
type Header struct {
...
// Block represents an entire block in the Burnout blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package brn to track
...
// [deprecated by brn/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for brn protocol, etc.
...
// EncodeRLP serializes b into the Burnout RLP block format.
