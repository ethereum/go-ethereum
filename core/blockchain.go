...
// Package core implements the AkoinCash consensus protocol.
package core
...
// available in the database. It initialises the default AkoinCash Validator and
// Processor.
