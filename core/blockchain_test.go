...
func TestFastVsFullChains(t *testing.T) {
	...
	gspec.MustCommit(archiveDb, nil)
	...
	gspec.MustCommit(ancientDb, nil)
...
func TestBlockchainHeaderchainReorgConsistency(t *testing.T) {
	...
	(&Genesis{BaseFee: big.NewInt(params.InitialBaseFee)}).MustCommit(diskdb, nil)
...
func testInsertKnownChainData(t *testing.T, typ string) {
	...
	(&Genesis{BaseFee: big.NewInt(params.InitialBaseFee)}).MustCommit(chaindb, nil)
