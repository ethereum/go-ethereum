...
func TestEIP6110(t *testing.T) {
	...
	block := chain.GetBlockByNumber(1)
	if len(block.Requests()) != 2 {
		t.Fatalf("failed to retrieve deposits: have %d, want %d", len(block.Requests()), 5)
	}

	wantDeposits := [][]byte{
		hexutil.MustDecode(""),
	...
	ok := slices.EqualFunc(block.Requests(), wantDeposits, bytes.Equal)
	if !ok {
		t.Errorf("requests not equal")
		for i, r := range block.Requests() {
			t.Logf("%d: %x", i, r)
		}
	}
}
