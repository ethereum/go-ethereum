...
func ReadSnapshotDisabled(db gdb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db gdb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db gdb.KeyValueWriter) {
...
func ReadSnapshotRoot(db gdb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db gdb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db gdb.KeyValueWriter) {
...
func ReadAccountSnapshot(db gdb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db gdb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db gdb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db gdb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db gdb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db gdb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db gdb.Iteratee, accountHash common.Hash) gdb.Iterator {
...
func ReadSnapshotJournal(db gdb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db gdb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db gdb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db gdb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db gdb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db gdb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db gdb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db gdb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db gdb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db gdb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db gdb.KeyValueWriter, status []byte) {
