...
var (
	...
	intrinsicContractCreationGas, _    = IntrinsicGas(code, nil, true, true, true, false)
	...
	intrinsicCodeWithExtCodeCopyGas, _ = IntrinsicGas(codeWithExtCodeCopy, nil, true, true, true, false)
)
...
func TestProcessVerkle(t *testing.T) {
	...
	genesis := gspec.MustCommit(db, true)
	blockchain, _ := NewBlockChain(db, nil, gspec, nil, ethash.NewFaker(), vm.Config{}, nil, nil)
	defer blockchain.Stop()
