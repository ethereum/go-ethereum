...
func TestEIP7623(t *testing.T) {
	...
	tests := []testsCases{
		{
			code:    common.FromHex(`0xff`),
			gas:     53018,
			gas7623: 53042,
			deploy:  true,
		},
		{
			code:    common.FromHex(`0x5f5f5500`),
			gas:     53054,
			gas7623: 53132,
			deploy:  true,
		},
		...
		{
			code:    common.FromHex(``),
			gas:     80746,
			gas7623: 122188,
			deploy:  true,
		},
	...
	for i, test := range tests {
		haveGas, _ := IntrinsicGas(test.code, nil, test.deploy, true, true, true, false)
		haveGas7623, _ := IntrinsicGas(test.code, nil, test.deploy, true, true, true, true)

		if haveGas != test.gas {
			t.Fatalf("invalid normal gas cost in test %v want %v got %v", i, test.gas, haveGas)
		}

		if haveGas7623 != test.gas7623 {
