...
// These functions are actually test functions, but they don't follow the TestXxx naming convention,
// so they can be called both from discv4_test by `go test`
// and by the discv4cmd
func PingTests(t *testing.T) {
