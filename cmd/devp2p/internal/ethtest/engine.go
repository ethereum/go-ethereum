...
// call sends an Engine API JSON-RPC request.
...
func (ec *EngineClient) sendForkchoiceUpdated(custody *types.CustodyBitmap) error {
	...
	if custody != nil {
		return ec.call("engine_forkchoiceUpdatedV4", state, nil, custody)
	}
