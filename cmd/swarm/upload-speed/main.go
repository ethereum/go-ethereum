...
func emitMetrics(ctx *cli.Context) error {
	if gethmetrics.Enabled {
		...
		return influxdb.InfluxDBWithTagsOnce(gethmetrics.DefaultRegistry, endpoint, database, username, password, "upload-speed", map[string]string{
			"host":     hosttag,
			"version":  gitCommit,
