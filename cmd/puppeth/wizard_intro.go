...
// setting up a new or managing an existing Burnout private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Burnout private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Burnout network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and brnstats servers |")
	...
	log.Info("Administering Burnout network", "name", w.network)
