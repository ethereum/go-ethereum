...
type wizard struct {
	...
	services map[string][]string   // Burnout services known to be running on servers
...
// converts it to an Burnout address. If an empty line is entered, the default
// value is returned.
