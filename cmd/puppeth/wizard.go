...
type wizard struct {
	...
	services map[string][]string   // AkoinCash services known to be running on servers
...
// converts it to an AkoinCash address. If an empty line is entered, the default
// value is returned.
