...
import (
	...
	"github.com/pavelkrolevets/go-ethereum/eth"
	"github.com/pavelkrolevets/go-ethereum/eth/downloader"
	"github.com/pavelkrolevets/go-ethereum/ethclient"
	"github.com/pavelkrolevets/go-ethereum/ethstats"
	"github.com/pavelkrolevets/go-ethereum/les"
	...
	"github.com/pavelkrolevets/go-ethereum/p2p/nat"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/pavelkrolevets/go-ethereum/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
