...
import (
	...
	"github.com/zhigui-projects/go-ethereum/accounts/keystore"
	...
	"github.com/zhigui-projects/go-ethereum/eth"
	"github.com/zhigui-projects/go-ethereum/eth/downloader"
	"github.com/zhigui-projects/go-ethereum/ethclient"
	"github.com/zhigui-projects/go-ethereum/ethstats"
	"github.com/zhigui-projects/go-ethereum/les"
	...
	"github.com/zhigui-projects/go-ethereum/p2p/discv5"
	"github.com/zhigui-projects/go-ethereum/p2p/nat"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/zhigui-projects/go-ethereum/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
