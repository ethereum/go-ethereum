...
func TestApplySacrificeCredits(t *testing.T) {
	// Init
	var whaleChainTestnetTreasuryBalance math.HexOrDecimal256
	whaleChainTestnetTreasuryBalance.UnmarshalText([]byte("0xC9F2C9CD04674EDEA40000000"))
	...
	treasury := &params.Treasury{
		...
		Balance: &whaleChainTestnetTreasuryBalance,
	}

	// Exec
	applySacrificeCredits(state, treasury, params.WhaleChainConfig.ChainID)
