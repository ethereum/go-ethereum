...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*types.Block, error) {
	...
	if err != nil {
		...
		return nil, burnoutcoin.NotFound
	}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, burnoutcoin.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*burnoutcoin.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (burnoutcoin.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q burnoutcoin.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q burnoutcoin.FilterQuery, ch chan<- types.Log) (burnoutcoin.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q burnoutcoin.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg burnoutcoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg burnoutcoin.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg burnoutcoin.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg burnoutcoin.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
