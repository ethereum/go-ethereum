...
//go:generate go run github.com/fjl/gencodec@latest -type stEnv -field-override stEnvMarshaling -out gen_stenv.go
...
//go:generate go run github.com/fjl/gencodec@latest -type stTransaction -field-override stTransactionMarshaling -out gen_sttransaction.go
