...
// Package graphql provides a GraphQL interface to AkoinCash node data.
package graphql
...
// Account represents an AkoinCash account at a particular block.
type Account struct {
...
// Transaction represents an AkoinCash transaction.
...
// Block represents an AkoinCash block.
...
type CallData struct {
	From     *common.Address // The AkoinCash address the call is from.
	To       *common.Address // The AkoinCash address the call is to.
