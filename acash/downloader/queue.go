...
import (
	...
	"github.com/dezzyboy/go-ethereum/common/prque"
...
type fetchRequest struct {
	...
	From    uint64          // [acash/62] Requested chain element index (used for skeleton fills only)
	Headers []*types.Header // [acash/62] Requested headers, sorted by request order
