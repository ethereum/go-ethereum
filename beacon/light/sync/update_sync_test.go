...
func TestUpdateSyncParallel(t *testing.T) {
	...
	ts.ServerEvent(EvNewOptimisticUpdate, testServer1, types.SignedHeader{SignatureSlot: 0x2000*100 + 0x1000})
	ts.AddServer(testServer2, 3)
	ts.ServerEvent(EvNewOptimisticUpdate, testServer2, types.SignedHeader{SignatureSlot: 0x2000*100 + 0x1000})
...
func TestUpdateSyncDifferentHeads(t *testing.T) {
	...
	ts.AddServer(testServer1, 1)
	ts.ServerEvent(EvNewOptimisticUpdate, testServer1, types.SignedHeader{SignatureSlot: 0x2000*15 + 0x1000})
	ts.AddServer(testServer2, 1)
	ts.ServerEvent(EvNewOptimisticUpdate, testServer2, types.SignedHeader{SignatureSlot: 0x2000*16 + 0x1000})
	ts.AddServer(testServer3, 1)
	ts.ServerEvent(EvNewOptimisticUpdate, testServer3, types.SignedHeader{SignatureSlot: 0x2000*17 + 0x1000})
	...
	ts.ServerEvent(EvNewOptimisticUpdate, testServer4, types.SignedHeader{SignatureSlot: 0x2000*17 + 0x1000})
