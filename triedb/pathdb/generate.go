...
// progressMarker returns the current generation progress marker. It may lag
// slightly behind the actual generation position (the progress field will only
// be updated once checkAndFlush is called), but it's acceptable.
