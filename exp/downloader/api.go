...
// Progress gives progress indications when the node is synchronising with the Expanse network.
...
// Syncing provides information when this nodes starts synchronising with the Expanse network and when it's finished.
