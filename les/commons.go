...
func (c *lesCommons) setupOracle(node *node.Node, genesis common.Hash, gconfig *gconfig.Config) *checkpointoracle.CheckpointOracle {
	config := gconfig.CheckpointOracle
	if config == nil {
