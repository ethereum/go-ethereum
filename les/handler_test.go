...
func testGetCHTProofs(t *testing.T, protocol int) {
	...
	trie, _ := trie.New(root, common.Hash{}, root, trie.NewDatabase(rawdb.NewTable(server.db, light.ChtTablePrefix), &trie.Config{Legacy: true}))
...
func testGetBloombitsProofs(t *testing.T, protocol int) {
	...
	for bit := 0; bit < 2048; bit++ {
		...
		trie, _ := trie.New(root, common.Hash{}, root, trie.NewDatabase(rawdb.NewTable(server.db, light.BloomTrieTablePrefix), &trie.Config{Legacy: true}))
