...
type peerConnection struct {
	...
	headerIdle  atomic.Bool // Current header activity state of the peer
	blockIdle   atomic.Bool // Current block activity state of the peer
	receiptIdle atomic.Bool // Current receipt activity state of the peer
	stateIdle   atomic.Bool // Current node data activity state of the peer
