...
func (leth *LightEthereum) stateAtBlock(ctx context.Context, block *types.Block) (*state.StateDB, func(), error) {
	return light.NewState(ctx, block.Header(), leth.odr), noopReleaser, nil
}

// stateAtTransaction returns the execution environment of a certain transaction.
func (leth *LightEthereum) stateAtTransaction(ctx context.Context, block *types.Block, txIndex int) (core.Message, vm.BlockContext, *state.StateDB, func(), error) {
	...
	statedb, rel, err := leth.stateAtBlock(ctx, parent)
	if err != nil {
		return nil, vm.BlockContext{}, nil, nil, err
	}
