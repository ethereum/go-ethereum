...
type accessTestFn func(db gdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db gdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db gdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db gdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db gdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
