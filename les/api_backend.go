...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmConfig *vm.Config) (*vm.EVM, func() error, error) {
	...
	return vm.NewEVM(context, txContext, state, b.xps.chainConfig, *vmConfig), state.Error, nil
}
...
func (b *LesApiBackend) SyncProgress() xpayments.SyncProgress {
	return b.xps.Downloader().Progress()
}

func (b *LesApiBackend) ProtocolVersion() int {
	return b.xps.LesVersion() + 10000
}
...
func (b *LesApiBackend) ChainDb() xpsdb.Database {
