...
.PHONY: chatty evm mist all test travis-test-with-coverage clean
GOBIN = build/bin

chatty:
	build/env.sh go install -v $(shell build/ldflags.sh) ./cmd/chatty
	@echo "Done building."
	@echo "Run \"$(GOBIN)/chatty\" to launch chatty."
