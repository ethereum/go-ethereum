...
export declare class Web3Eth extends Web3Context<Web3EthExecutionAPI, RegisteredSubscription> {
     ...
     * }
     */
    calculateFeeData(baseFeePerGasFactor?: bigint | number, alternativeMaxPriorityFeePerGas?: bigint): Promise<FeeData>;
    getFeeData: (baseFeePerGasFactor?: bigint | number, alternativeMaxPriorityFeePerGas?: bigint) => Promise<FeeData>;
    /**
     ...
     * ```
     */
    getUncle<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(block: (HexString32Bytes | BlockNumberOrTag) | undefined, uncleIndex: Numbers, returnFormat?: ReturnFormat): Promise<{
    ...
    getTransactionReceipt<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(transactionHash: Bytes, returnFormat?: ReturnFormat): Promise<{
        ...
        events?: {
            [x: string]: {
                ...
                readonly logIndex?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
                readonly transactionIndex?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
                readonly transactionHash?: HexString32Bytes | undefined;
                readonly blockHash?: HexString32Bytes | undefined;
                readonly blockNumber?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
     ...
     * ```
     */
    createNewPendingTransactionFilter<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(returnFormat?: ReturnFormat): Promise<import("web3-types").NumberTypes[ReturnFormat["number"]]>;
    /**
     ...
     * ```
     */
    createNewFilter<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(filter: FilterParams, returnFormat?: ReturnFormat): Promise<import("web3-types").NumberTypes[ReturnFormat["number"]]>;
    /**
     ...
     * ```
     */
    createNewBlockFilter<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(returnFormat?: ReturnFormat): Promise<import("web3-types").NumberTypes[ReturnFormat["number"]]>;
    /**
     ...
     * ```
     */
    uninstallFilter(filterIdentifier: Numbers): Promise<boolean>;
    /**
     ...
     *   {...}]
     */
    getFilterChanges<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(filterIdentifier: Numbers, returnFormat?: ReturnFormat): Promise<(string | {
        readonly id?: string | undefined;
        readonly removed?: boolean | undefined;
        readonly logIndex?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
        readonly transactionIndex?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
     ...
     *   {...}]
     */
    getFilterLogs<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(filterIdentifier: Numbers, returnFormat?: ReturnFormat): Promise<(string | {
        readonly id?: string | undefined;
        readonly removed?: boolean | undefined;
        readonly logIndex?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
        readonly transactionIndex?: import("web3-types").NumberTypes[ReturnFormat["number"]] | undefined;
