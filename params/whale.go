...
var (
	WhaleChainConfig = &ChainConfig{
		ChainID:                       big.NewInt(370),
	...
	WhaleChainTestnetV4Config = &ChainConfig{
		ChainID:                       big.NewInt(944),
		HomesteadBlock:                big.NewInt(1_150_000),
		DAOForkBlock:                  big.NewInt(1_920_000),
		DAOForkSupport:                true,
		EIP150Block:                   big.NewInt(2_463_000),
...
func testnetTreasury() *Treasury {
	...
	whaleChainTestnetTreasuryBalance.UnmarshalText([]byte("0x314DC6448D9338C15B0A00000000"))

	return &Treasury{
		Addr:    "0x18f26B95164Fa799b32809311c5eE098e075c3C3",
