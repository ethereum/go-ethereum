...
func TestDifferenceIterator(t *testing.T) {
	...
	dba.Update(rootA, types.EmptyMerkleHash, trienode.NewWithNodeSet(nodesA))
	...
	dbb.Update(rootB, types.EmptyMerkleHash, trienode.NewWithNodeSet(nodesB))
...
func testIteratorContinueAfterError(t *testing.T, memonly bool, scheme string) {
	...
	tdb.Update(root, types.EmptyMerkleHash, trienode.NewWithNodeSet(nodes))
	if !memonly {
		tdb.Commit(root)
	}
