...
type Database struct {
	diskdb gdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb gdb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb gdb.KeyValueStore, config *Config) *Database {
...
func (db *Database) commit(hash common.Hash, batch gdb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
