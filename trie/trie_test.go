...
// Used for testing
func newEmpty() *Trie {
	trie, _ := New(common.Hash{}, NewDatabase(keyvalue.NewMemoryDatabase()))
	return trie
}
...
func TestMissingRoot(t *testing.T) {
	trie, err := New(common.HexToHash("0beec7b5ea3f0fdbc95d0dd47f3c5bc275da8a33"), NewDatabase(keyvalue.NewMemoryDatabase()))
	if trie != nil {
...
func testMissingNode(t *testing.T, memonly bool) {
	diskdb := keyvalue.NewMemoryDatabase()
...
func runRandTest(rt randTest) bool {
	triedb := NewDatabase(keyvalue.NewMemoryDatabase())
...
func benchGet(b *testing.B, commit bool) {
	...
	if commit {
		ldb := trie.db.diskdb.(*keyvalue.LeveldbDatabase)
		ldb.Close()
...
func tempDB() (string, *Database) {
	...
	diskdb, err := keyvalue.NewLeveldbDatabase(dir, 256, 0, "")
	if err != nil {
