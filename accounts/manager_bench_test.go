...
func (w *fakeWallet) URL() URL { return URL{} }
func (w *fakeWallet) Status() (string, error) { return "", nil }
func (w *fakeWallet) Open(string) error { return nil }
...
func (w *fakeWallet) Derive(DerivationPath, bool) (Account, error) { return Account{}, nil }
func (w *fakeWallet) SelfDerive([]DerivationPath, ethereum.ChainStateReader) {}
func (w *fakeWallet) SignData(Account, string, []byte) ([]byte, error) { return nil, nil }
func (w *fakeWallet) SignDataWithPassphrase(Account, string, string, []byte) ([]byte, error) {
	return nil, nil
}
func (w *fakeWallet) SignText(Account, []byte) ([]byte, error) { return nil, nil }
func (w *fakeWallet) SignTextWithPassphrase(Account, string, []byte) ([]byte, error) { return nil, nil }
