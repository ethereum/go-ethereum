...
import (
	...
	"github.com/EtherFact-Project/go-etherfact/accounts/abi"
...
// valid EtherFact transaction.
type TransactOpts struct {
	From   common.Address // EtherFact account to send the transaction from
...
// EtherFact network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the EtherFact blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct EtherFact methods
...
// DeployContract deploys a contract onto the EtherFact blockchain and binds the
