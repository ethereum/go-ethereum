...
func TestNewSimulatedBackend_AdjustTimeFail(t *testing.T) {
	...
	sim := simTestBackend(testAddr)
	// Create tx and send
	tx := types.NewTransaction(0, testAddr, big.NewInt(1000), params.TxGas, big.NewInt(1), nil, nil, nil)
	...
	tx2 := types.NewTransaction(1, testAddr, big.NewInt(1000), params.TxGas, big.NewInt(1), nil, nil, nil)
