...
func NewSimulatedBackend(alloc core.GenesisAlloc) *SimulatedBackend {
	...
	genesis := core.Genesis{Config: params.AllUbqhashProtocolChanges, Alloc: alloc}
	genesis.MustCommit(database)
	blockchain, _ := core.NewBlockChain(database, genesis.Config, ubqhash.NewFaker(), vm.Config{})
