...
func TestTypeCheck(t *testing.T) {
	...
	for i, test := range []struct {
		...
		{"uint24[]", nil, []uint32{1, 2, 3}, ""},
		{"uint24[]", nil, [3]uint32{1, 2, 3}, ""},
		{"uint24[]", nil, []uint64{1, 2, 3}, "abi: cannot use []uint64 as type [0]uint32 as argument"},
		{"uint24[3]", nil, [3]uint64{1, 2, 3}, "abi: cannot use [3]uint64 as type [3]uint32 as argument"},
		{"uint24[3]", nil, [4]uint32{1, 2, 3}, "abi: cannot use [4]uint32 as type [3]uint32 as argument"},
		{"uint24[3]", nil, []uint32{1, 2, 3}, ""},
		{"uint24[3]", nil, []uint32{1, 2, 3, 4}, "abi: cannot use [4]uint32 as type [3]uint32 as argument"},
		{"uint40[]", nil, []uint64{1, 2, 3}, ""},
		{"uint40[]", nil, [3]uint64{1, 2, 3}, ""},
		{"uint40[3]", nil, [4]uint64{1, 2, 3}, "abi: cannot use [4]uint64 as type [3]uint64 as argument"},
		{"uint40[3]", nil, []uint64{1, 2, 3}, ""},
		{"uint40[3]", nil, []uint64{1, 2, 3, 4}, "abi: cannot use [4]uint64 as type [3]uint64 as argument"},
		{"uint48[]", nil, []uint64{1, 2, 3}, ""},
		{"uint48[]", nil, [3]uint64{1, 2, 3}, ""},
		{"uint48[3]", nil, [4]uint64{1, 2, 3}, "abi: cannot use [4]uint64 as type [3]uint64 as argument"},
		{"uint48[3]", nil, []uint64{1, 2, 3}, ""},
		{"uint48[3]", nil, []uint64{1, 2, 3, 4}, "abi: cannot use [4]uint64 as type [3]uint64 as argument"},
		{"uint56[]", nil, []uint64{1, 2, 3}, ""},
		{"uint56[]", nil, [3]uint64{1, 2, 3}, ""},
		{"uint56[3]", nil, [4]uint64{1, 2, 3}, "abi: cannot use [4]uint64 as type [3]uint64 as argument"},
		{"uint56[3]", nil, []uint64{1, 2, 3}, ""},
		{"uint56[3]", nil, []uint64{1, 2, 3, 4}, "abi: cannot use [4]uint64 as type [3]uint64 as argument"},
