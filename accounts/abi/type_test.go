...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"uint16[0]", nil, [0]uint32{}, "abi: error parsing variable size: not allow zero length array"},
		...
		{"address[0]", nil, [0]common.Address{}, "abi: error parsing variable size: not allow zero length array"},
