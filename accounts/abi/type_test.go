...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"uint16[3]", nil, []uint16{1, 2, 3, 4}, "abi: cannot use []uint16 as type [3]uint16 as argument"},
		{"address[]", nil, []common.Address{{1}}, ""},
		{"address[0]", nil, [0]common.Address{}, ""},
		{"address[0]", nil, []common.Address{{1}}, "abi: cannot use []array as type [0]array as argument"},
