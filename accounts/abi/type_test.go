...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"uint16[0]", nil, [0]uint32{}, "abi: cannot use [0]uint32 as type [0]uint16 as argument"},
		...
		{"uint16[3]", nil, []uint16{1, 2, 3, 4}, "abi: cannot use []uint16 of length 4 as type [3]uint16"},
		{"address[]", nil, []common.Address{{1}}, ""},
		{"address[0]", nil, [0]common.Address{}, ""},
		{"address[0]", nil, []common.Address{{1}}, "abi: cannot use []array of length 1 as type [0]array"},
