...
// GetCrypto returns a string indicating the available cryptographic functionalities.
func GetCrypto() string {
	return "Available cryptographic functionalities: BLAKE2b, BN256, ECIES, KZG4844, SECP256K1"
}
