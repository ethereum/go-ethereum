...
if the appropriate `Accept` header is set)).
*/
package http
...
// ErrorParams are the needed params for formatting the correct HTML page
...
// CaseError is a custom error case struct that would be used to store validators and
