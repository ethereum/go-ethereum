...
// It returns the SwarmResponse object, which serialises containing the
// response body as the value of the Content field
// NOTE: if error is non-nil, SwarmResponse may still have partial content
...
func (self *Storage) Get(bzzpath string) (*Response, error) {
	...
	return &Response{mimeType, status, expsize, body[:size]}, err
}
