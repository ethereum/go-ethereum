...
// StorageHandler is the interface type for handler of storage/retrieval related requests coming
...
/*
Bzz is the main entrypoint. Wrappers starting a server that will run the bzz protocol
