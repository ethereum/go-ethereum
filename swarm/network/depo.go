...
// Depo is the handler for storage/retrieval related protocol requests
...
// HandleUnsyncedKeysMsg handles UnsyncedKeysMsg after msg decoding - unsynced hashes upto sync state
...
// HandleStoreRequestMsg is the entrypoint for store requests coming from the bzz wire protocol
...
// HandleRetrieveRequestMsg is entrypoint for retrieve requests coming from the bzz wire protocol
