...
//
// # go test -benchmem -run=none github.com/ubiq/go-ubiq/swarm/storage/localstore -bench BenchmarkPutUpload -v
//
// goos: darwin
// goarch: amd64
// pkg: github.com/ubiq/go-ubiq/swarm/storage/localstore
