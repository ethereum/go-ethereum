...
func init() {
	var err error
	RandomKey, err = hexutil.Decode("0x8abf1502f557f15026716030fb6384792583daf39608a3cd02ff2f47e9bc6e49")
	if err != nil {
		panic(err.Error())
	}
}
...
func TestEncryptDataLongerThanPadding(t *testing.T) {
	enc := New(RandomKey, 4095, uint32(0), hashFunc)
...
func TestEncryptDataZeroPadding(t *testing.T) {
	enc := New(RandomKey, 0, uint32(0), hashFunc)
...
func TestEncryptDataLengthEqualsPadding(t *testing.T) {
	enc := New(RandomKey, 4096, uint32(0), hashFunc)
