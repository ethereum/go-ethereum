...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/getf.ipc",
			endpoint:    "/data/testnet/getf.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/getf.ipc",
			endpoint:    "/data/testnet/getf.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/getf.ipc",
			endpoint:    "/data/testnet/getf.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/getf.ipc",
			endpoint:    "/data/testnet/getf.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
