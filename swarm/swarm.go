...
// Stop implements the node.Service interface and stops all component services.
...
// NewLocalSwarm creates a Local swarm without netStore.
...
// Info organizes serialisable info about swarm.
type Info struct {
	*api.Config
	*chequebook.Params
}
