...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db ethdb.Database, n int) *testWorkerBackend {
	...
	chain, _ := core.NewBlockChain(db, &core.CacheConfig{TrieDirtyDisabled: true}, gspec.Config, engine, new(vm.Config), nil, nil)
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	chain, _ := core.NewBlockChain(db2, nil, b.chain.Config(), engine, new(vm.Config), nil, nil)
	defer chain.Stop()
