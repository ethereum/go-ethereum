...
type generateParams struct {
	...
	inclusionListTxs []*types.Transaction // List of transactions to include in block (cancun field).
...
func (miner *Miner) prepareWork(genParams *generateParams, witness bool) (*environment, error) {
	...
	env, err := miner.makeEnv(parent, header, genParams.coinbase, genParams.inclusionListTxs, witness)
	if err != nil {
...
func (miner *Miner) makeEnv(parent *types.Header, header *types.Header, coinbase common.Address, inclusionListTxs []*types.Transaction, witness bool) (*environment, error) {
